...
const Sidebar = () => {
    ...
    return (
        <div className={`bg-[#8185b2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? "max-md:hidden" : "max-md:block"}`}>
            <div className='pb-5'>
                ...
                <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4'>
                    ...
                    <input 
                        onChange={(e) => setInput(e.target.value)} // ⭐ FIXED
                        value={input}
                        type="text" 
